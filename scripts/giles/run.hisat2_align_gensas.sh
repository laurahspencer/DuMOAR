...
#SBATCH --job-name=HISAT2_AlignGENSAS
#SBATCH --output=HISAT2_AlignGENSAS.%A.txt
#SBATCH -c 20
#SBATCH -t 0
...
REF=${BASE}/ref/HiC_HISAT2_GENSAS/HiC_HISAT2
OUT=${BASE}/hisat2/scaffolds_only_gensas
IN=${BASE}/trimmed
