...
#SBATCH --output=BUSCO.PGA_Assembly.scaffolds_only.%A.txt
...
REF=${BASE}/ref/fasta/PGA_assembly.scaffolds_only.fasta
LINEAGE=arthropoda_odb10
OUT=${BASE}/busco/PGA_assembly.scaffolds_only.arthropoda_odb10
