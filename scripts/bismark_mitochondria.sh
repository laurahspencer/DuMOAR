...
#SBATCH --job-name=bismark-mito
#SBATCH --output=/home/lspencer/DuMOAR/sbatch/bismark-20230531.txt
...
OUT="/scratch/lspencer/DuMOAR/aligned/mito/"
...
--parallel 20 \
--bowtie2 \
/home/lspencer/references/dungeness-mito/
...
--bowtie2 \
-genome /home/lspencer/references/dungeness-mito/ \
-p 4 \
-score_min L,0,-0.6 \
--non_directional \
-1 ${IN}{}_R1.fastq \
